...
template <typename Dtype>
class SoftmaxWithLoss3Layer : public Layer<Dtype> {
 public:
   /**
    ...
    */
  explicit SoftmaxWithLoss3Layer(const LayerParameter& param)
      : Layer<Dtype>(param) {}
  virtual void LayerSetUp(const vector<Blob<Dtype>*>& bottom,
      const vector<Blob<Dtype>*>& top);
  virtual void Reshape(const vector<Blob<Dtype>*>& bottom,
  ...
  virtual inline const char* type() const { return "SoftmaxWithLoss3"; }
  virtual inline int ExactNumTopBlobs() const { return -1; }
  virtual inline int MinTopBlobs() const { return 1; }
...
template <typename Dtype>
class SmoothL1Loss3Layer : public Layer<Dtype> {
public:
	explicit SmoothL1Loss3Layer(const LayerParameter& param)
	...
	virtual inline const char* type() const { return "SmoothL1Loss3"; }
